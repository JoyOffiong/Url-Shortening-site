...
export function HeroSection() {
  return (
    <React.Fragment>
      <div className="phone:flex flex-col-reverse py-5 px-10 text-center  laptop:flex-row laptop:px-20 items-center ">
        <div className="phone:w-full laptop:w-2/5 text-left">
          <h3 className="font-bold pb-5 phone:text-center phone:text-5xl laptop:text-left text-5xl ">
