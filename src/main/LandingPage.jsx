    ...
    <div className="bg-tetiaryColor flex flex-col mt-8 ">
     ...
     <Header/>
      ...
      <div className="px-20 flex flex-col gap-10 mt-20">
        ...
        <div className="mb-12 font-bold text-3xl"> <p>Key Activities</p></div>
       
        <div className="mt-[24px] flex flex-row flex-wrap justify-between">
        
          <div className="rounded-[100px] relative h-[300px] w-[30%]  shadow-2xl">
          <div className="flex items-center justify-center absolute -top-10 left-28  rounded-full   ">
            <img src="/assets/DL3.webp" alt="mission" className="rounded-full object-cover h-[120px] w-[120px] "/>
          </div>  
          <div className="mt-24 p-4 absolute text-center ">
             <h3 className="font-bold text-xl pb-4 ">Free Digital Courses </h3>
              <p className="text-md font-normal"> Access a wide range of digital courses, from basic computer skills to advanced programming, absolutely free.</p>
          </div>
           
          </div>

          <div className="rounded-[100px] relative h-[300px] w-[30%]  shadow-lg">
          <div className="flex items-center justify-center absolute -top-10 left-28  rounded-full   ">
            <img src="/assets/DL1.webp" alt="mission" className="rounded-full object-cover h-[120px] w-[120px] "/>
          </div>  
          <div className="mt-24 p-4 absolute text-center ">
             <h3 className="font-bold text-xl pb-4 ">Live Workshops</h3>
              <p className="text-md font-normal"> Engage in interactive live workshops conducted by industry experts.</p>
          </div>
          ...
          <div className="rounded-[100px] relative h-[300px] w-[30%]  shadow-lg">
          <div className="flex items-center justify-center absolute -top-10 left-28  rounded-full   ">
            <img src="/assets/DL2.webp" alt="mission" className="rounded-full object-cover h-[120px] w-[120px] "/>
          </div>  
          <div className="mt-24 p-4 absolute text-center ">
             <h3 className="font-bold text-xl  pb-4">Community Support </h3>
              <p className="text-md font-normal"> Connect with a supportive community of learners and mentors</p>
          </div>
